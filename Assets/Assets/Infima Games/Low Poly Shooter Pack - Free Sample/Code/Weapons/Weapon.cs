...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class Weapon : WeaponBehaviour
    {
        ...
        private bool initializedForPickup;
        protected override void Start() => InitializeForPickup();
        public void InitializeForPickup()
        {
            if (initializedForPickup) return;
            initializedForPickup = true;
