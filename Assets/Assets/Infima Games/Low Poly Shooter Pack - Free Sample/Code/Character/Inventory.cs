...
namespace InfimaGames.LowPolyShooterPack
{
    public class Inventory : InventoryBehaviour
    {
        ...
        public override void Init(int equippedAtStart = 0)
        {
            ...
            //Equip.
            if (weapons.Length > 0) Equip(equippedAtStart);
        }
        ...
        public WeaponBehaviour Acquire(WeaponBehaviour prefab)
{
 var weapon = Instantiate(prefab, transform);
 weapon.gameObject.SetActive(true);
 if (weapon is Weapon concreteWeapon) concreteWeapon.InitializeForPickup();
